...
```{r echo = FALSE}
#adapted from app at https://gist.github.com/dgrapov/dfcf6ab2339b1cf19b090cfb8dadc855 
...
ui<-(pageWithSidebar(
  ...
  (
    ...
    selectInput("variable","Y:", choices = NULL),
    selectInput("group","X:", choices = NULL),
